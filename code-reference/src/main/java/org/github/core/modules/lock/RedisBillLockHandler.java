...
import org.github.core.modules.cache.RedisManage;
...
/**
 * 分布式锁 使用例子 在springXml中 配置 <bean id="redisManage" class="RedisManage"/>
 * 
 * <bean id="redisBillLockHandler" class="RedisBillLockHandler"/>
 * 
