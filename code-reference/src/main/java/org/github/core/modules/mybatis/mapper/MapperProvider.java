...
import org.github.core.modules.mybatis.helper.MapperHelper;
import org.github.core.modules.mybatis.helper.MapperTemplate;
...
//            }
    ...
    public SqlNode delete(MappedStatement ms) {
        ...
        List<SqlNode> sqlNodes = new ArrayList<SqlNode>();
        //delete from table
        sqlNodes.add(new StaticTextSqlNode("DELETE FROM " + tableName(entityClass) +" where "));
        //where/if判断条件
        TrimSqlNode trimSqlNode = new TrimSqlNode(ms.getConfiguration(), getAllIfColumnNode(entityClass), " ", "AND ", null, null);
