...
public class ConnectUtil {
	 ...
	 * 
	 */
	public static String doPost(String url, Map<String, String> params, String charset, int connectTimeout, int soTimeout, String proxyipport) throws
            BusinessException {
		if (StringUtils.isBlank(url)) {
			return null;
		}
		...
		try {
			...
			if (statusCode != 200) {
				httpPost.abort();
				throw new BusinessException("HttpClient,error status code :" + statusCode + " content:" + result);
			}
			return result;
