...
public class FileOperate {
	...
	public static void writeTxt(String path, String filename, String fileContent, String encoding) throws IOException {
		writeTxt (path,filename,fileContent,encoding,false);
	}
	 ...
	 * @param encoding
	 *            编码
	 *            @param append true 追加到末尾  false 新建文件
	 * @throws IOException
	 *
	 * @see [类、类#方法、类#成员]
	 */
	public static void writeTxt(String path, String filename, String fileContent, String encoding,boolean append) throws IOException {
		...
		FileUtils.writeStringToFile(file, fileContent, encoding,append);
	}
