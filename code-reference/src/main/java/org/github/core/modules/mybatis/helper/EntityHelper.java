package org.github.core.modules.mybatis.helper;
...
import org.github.core.modules.mybatis.entity.BusinessId;
                ...
                if (generatedValue.generator().toUpperCase().equals("UUID")) {
                    ...
                    if (generatedValue.strategy() == GenerationType.IDENTITY) {
                        ...
                        if (!generatedValue.generator().equals("")) {
                            ...
                            MapperHelper.IdentityDialect identityDialect =
                                    MapperHelper.IdentityDialect.getDatabaseDialect(generatedValue.generator());
                        ...
                        throw new RuntimeException(field.getName()
                                ...
                                "\n3.类似mysql数据库的@GeneratedValue(strategy=GenerationType.IDENTITY[,"
                                + "generator=\"Mysql\"])");
                    }
                }
            }
